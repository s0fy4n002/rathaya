...
<script src="/th/be/js/plugins/datatable.serverside.provinces.js"></script>
@endsection
                    ...
                    <div class="page-title-container">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7">
                                <h1 class="mb-0 pb-0 display-4" id="title">Province List</h1>
                            ...
                            <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                                ...
                                <a href="{{ route('provinces.create') }}" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-datatable"><i data-acorn-icon="plus"></i> <span>Add New</span></a>
                                {{-- Add New Button End --}}
                            </div>
                            {{-- Top Buttons End --}}
                        </div>
