                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Slider List</h1>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-muted text-small text-uppercase">Button (ID)</th>
                                                <th class="text-muted text-small text-uppercase">Button (EN)</th>
                                        ...
                                        <tbody>
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-alternate">{{ $data->button_lid }}</td>
                                                    <td class="text-alternate">{{ $data->button_len }}</td>
                                                    ...
                                                    <td class="text-alternate">
                                                        <form action="{{ route('sliders.destroy', $data->id) }}" method="post">
                                                            ...
                                                            @can('master-edit')
                                                                <a href="{{ route('sliders.edit', $data->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                            @endcan
                                                            {{-- @can('master-delete') --}}
