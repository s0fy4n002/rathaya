                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Edit Enabler</h1>
                        ...
                        <section class="scroll-section" id="basic">
                            ...
                            <div class="card mb-5">
                                ...
                                {{-- tooltip-label-end inputs should be wrapped in form-group class --}}
                                    <form id="frmPermission" class="tooltip-label-end" action="{{ route('enablers.update', $data->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method("PUT")
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <img src="/imgenablers/{{ $data->logo <> '' ? $data->logo : 'empty.jpg' }}" class="img-fluid rounded img-fluid rounded mb-1 me-1 sw-35" alt="logo image" />
                                        </div>
                                        <div class="mb-3 position-relative form-group">
