                        ...
                        <section class="scroll-section" id="basic">
                            ...
                            <div class="card mb-5">
                                ...
                                {{-- tooltip-label-end inputs should be wrapped in form-group class --}}
                                    <form id="frmUser" class="tooltip-label-end" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" autocomplete="new-password" required />
                                        ...
                                        {{-- <div class="mb-3 w-100">
                                            ...
                                            <select name="profile_verified" id="cboProfileStatus" required>
                                                <option label="&nbsp;"></option>
                                                <option value="0" selected>0 - Not Verified</option>
                                        ...
                                        <div class="mb-3 w-100">
                                            ...
                                            <select name="userstatus_id" id="cboUserStatus" required>
                                                ...
                                                <option value="2">2 - Locked</option>
                                            </select>
                                        </div>
                                        <div class="mb-3 position-relative form-group">
                                        ...
                                        <button type="submit" class="btn btn-icon btn-icon-end btn-primary"><span>Create User</span><i data-acorn-icon="chevron-right"></i></button>
                                    </form>
                                </div>
                            </div>
                        </section>
