                ...
                <div class="col">
                    ...
                    <div>{{-- Content Start --}}
                        ...
                        <section class="scroll-section" id="form-permission">{{-- Form Start --}}
                            ...
                            <form class="tooltip-end-top" id="validationTopLabel" action="{{ route('permissions.store') }}" method="post">
                            <!-- <form class="tooltip-end-top" id="rulesForm" action="{{ route('permissions.store') }}" method="post"> -->
                                @csrf
                                <div class="card mb-5">
                                    <div class="card-body">
