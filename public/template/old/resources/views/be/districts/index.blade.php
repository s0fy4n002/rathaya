...
<script src="/th/be/js/plugins/datatable.serverside.districts.js"></script>
@endsection
                    ...
                    <div class="page-title-container">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7">
                                <h1 class="mb-0 pb-0 display-4" id="title">District List</h1>
                            ...
                            <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                                ...
                                <button type="button" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-datatable" onclick="window.location.href='{{ route('districts.create') }}';">
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#datatableRowsServerSide" data-childSelector="span">
                                        ...
                                        <div class="dropdown-menu shadow dropdown-menu-end">
                                            ...
                                            <a class="dropdown-item" href="#">8000 Items</a>
                                        </div>
                                    </div>
                                    {{-- Length End --}}
                                </div>
