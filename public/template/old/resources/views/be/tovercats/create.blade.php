@php
    ...
    $title = 'Create Turnover Category';
    $description = 'Create Turnover Category.';
    $breadcrumbs = ["/"=>"Home"]
@endphp
                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Create Turnover Category</h1>
                                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Turnover Category</a></li>
                        ...
                        <section class="scroll-section" id="basic">
                            ...
                            <div class="card mb-5">
                                ...
                                {{-- tooltip-label-end inputs should be wrapped in form-group class --}}
                                    <form id="frmPermission" class="tooltip-label-end" action="{{ route('tovercats.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="cat_lid" value="{{ old('cat_lid') }}" required />
                                            <div class="form-text">Input <strong>minimum 5 characters.</strong></div>
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            <label class="form-label">Category (ID)*</label>
                                            <input type="text" class="form-control" name="cat_len" value="{{ old('cat_len') }}" required />
                                            <div class="form-text">Input <strong>minimum 5 characters.</strong></div>
