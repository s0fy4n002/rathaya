                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Commodity List</h1>
                            ...
                            <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">{{-- Top Buttons Start --}}
                                ...
                                <button type="button" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-datatable" onclick="window.location.href='{{ route('commoditycats.create') }}';">
                                            ...
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-alternate">
                                                        <form action="{{ route('commoditycats.destroy', $data->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                                {{-- <a href="{{ route('commodities.show', $data->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>--}}
                                                            @can('master-edit')
                                                                <a href="{{ route('commoditycats.edit', $data->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                            @endcan
                                                            {{-- @can('master-delete') --}}
