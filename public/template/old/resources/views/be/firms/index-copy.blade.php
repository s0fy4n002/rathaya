                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-muted text-small text-uppercase">Entitiy</th>
                                        ...
                                        <tbody>
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-alternate">{{ $data->bentity_id }}</td>
                                                    ...
                                                    <td class="text-alternate">
                                                        <form action="{{ route('firms.destroy', $data->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="{{ route('firms.show', $data->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>
                                                            @can('master-edit')
