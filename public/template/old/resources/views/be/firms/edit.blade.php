                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Edit Business</h1>
                                ...
                                {{-- tooltip-label-end inputs should be wrapped in form-group class --}}
                                    <form id="frmData" class="tooltip-label-end" action="{{ route('firms.update', $data->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="wanumber" value="{{ $data->wanumber }}" required />
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <input type="text" class="form-control" name="established" value="{{ $data->established }}" required />
                                            @error('established')<div class="form-text text-danger">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="mb-3 position-relative form-group">
                                            <label class="form-label">Area*</label>
                                            <input type="number" class="form-control" name="area" value="{{ $data->area }}" min="0" max="10000" required />
                                            @error('area')<div class="form-text text-danger">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="mb-3 position-relative form-group">
                                            <label class="form-label">Number of Employee*</label>
                                            <input type="number" class="form-control" name="employee" value="{{ $data->employee }}" min="0" max="10000" required />
                                            @error('employee')<div class="form-text text-danger">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="mb-3 position-relative form-group w-100">
                                            <label class="form-label">Turnover Catagory*</label>
                                        ...
                                        <div class="mb-3 position-relative form-group">
                                            ...
                                            <img src="/imgfirms/{{ $data->photo <> '' ? $data->photo : 'empty.jpg' }}" class="mt-2 img-fluid rounded img-fluid rounded mb-1 me-1 sw-35" alt="photo image" style="max-width:100px;width:100%"/>
                                        </div>
                                        <div class="mb-3 position-relative form-group">
                                            <label class="form-label">Document*</label>
                                            <input type="file" class="form-control" name="document" accept="application/pdf" />
                                            <div class="form-text">File : .pdf max size 10MB. | <a href="/pdffirms/{{ $data->document }}" target="_blank">{{ $data->document }}</a></div>
                                            ...
                                            @foreach($invneeds as $invneed)
                                                <div class="mb-1">
                                                    <label class="form-check custom-icon mb-0">
                                                        <input type="checkbox" class="form-check-input" name="firminv[]" value="{{ $invneed->id }}" {{ in_array($invneed->id, $selectedInvneeds) ? 'checked' : '' }} required />
