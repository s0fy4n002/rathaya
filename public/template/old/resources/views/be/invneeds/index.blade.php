@php
    ...
    $title = 'Investment Need List';
    $description = 'Investment Need List.';
    $breadcrumbs = ["/"=>"Home"]
@endphp
                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Investment Need List</h1>
                                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Investment Need</a></li>
                            ...
                            <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">{{-- Top Buttons Start --}}
                                ...
                                <button type="button" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-datatable" onclick="window.location.href='{{ route('invneeds.create') }}';">
                                            ...
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-alternate">
                                                        <form action="{{ route('invneeds.destroy', $data->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                                {{-- <a href="{{ route('invneeds.show', $data->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Show</a>--}}
                                                            @can('master-edit')
                                                                <a href="{{ route('invneeds.edit', $data->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                            @endcan
                                                            {{-- @can('master-delete') --}}
