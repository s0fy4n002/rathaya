                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            <div class="col-12 col-md-7">{{-- Title Start --}}
                                <h1 class="mb-0 pb-0 display-4" id="title">Permission Lists</h1>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            @forelse ($permissions as $permission)
                                                <tr>
                                                    <td>{{ $permission->id }}</td>
                                                    <td class="text-alternate">{{ $permission->name }}</td>
                                                    <td class="text-alternate">
                                                        <form action="{{ route('permissions.destroy', $permission->id) }}" method="post">
                                                            ...
                                                            @can('permission-edit')
                                                                <a href="{{ route('permissions.edit', $permission->id) }}" class="btn btn-primary btn-sm">{{-- <idata-acorn-icon="edit"data-acorn-size="13"></i> --}} Edit</a>
                                                            @endcan
                                                            {{-- @can('permission-delete')
                                                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Do you want to delete this permission?');"><idata-acorn-icon="bin"data-acorn-size="13"></i> Delete</button>
                                                            @endcan --}}
                                                        </form>
                                                    </td>
                                                </tr>
