                    ...
                    <div class="page-title-container">{{-- Title and Top Buttons Start --}}
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">{{-- Top Buttons Start --}}
                                ...
                                <button type="button" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-datatable" onclick="window.location.href='{{ route('products.create') }}';">
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-muted text-small text-uppercase">Retail (Rp)</th>
                                                <th class="text-muted text-small text-uppercase">Wholesaler (Rp)</th>
                                        ...
                                        <tbody>
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td class="text-alternate">{{ number_format($data->priceretailer) }}</td>
                                                    <td class="text-alternate">{{ number_format($data->pricewholesaler) }}</td>
                                                    ...
                                                    <td class="text-alternate">
                                                        <form action="{{ route('products.destroy', $data->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="{{ route('products.show', $data->id) }}" class="btn btn-warning btn-sm"><i data-acorn-icon="eye"data-acorn-size="13"></i> Show</a>
                                                            @can('master-edit')
                                                                <a href="{{ route('products.edit', $data->id) }}" class="btn btn-primary btn-sm"><i data-acorn-icon="edit" data-acorn-size="13"></i> Edit</a>
                                                            @endcan
                                                            {{-- @can('master-delete') --}}
